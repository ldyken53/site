    ...
    return (
        <div style={{display: 'flex', flexDirection: 'row'}} className="col-12 page">
            ...
            <div style={{display: 'flex', flexDirection: 'column'}}>
                ...
                <div>Welcome! I’m Landon, a PhD student and graduate research assistant at the University of Alabama at Birmingham. I am currently pursuing a degree in Computer Science under my advisor Dr. Sidharth Kumar. My focus is on the subjects of data visualization and high performance computing, specifically around web-based graphics tools and GPU-accelerated systems. I also experiment with some more machine learning and AI-focused projects in my free time. Before beginning my PhD, I received a dual B.S. in Mathematics and Computer Science from the University of Alabama at Birmingham in 2021. Please feel free to connect with me through any of the platforms below, and check out some of my projects and publications!</div>
                <br />
